...
![User Persona 1: Jorge Aguilar - Personal de Gestión y Propietarios de Taller](report/assets/NeedFinding/User-Personas/User-Persona-Jorge-Aguilar.png){#fig:user-persona-jorge}
...
![User Persona 2: César Nikolay - Personal Operativo del Taller](report/assets/NeedFinding/User-Personas/User-Persona-Cesar-Nikolay.png){#fig:user-persona-cesar}
