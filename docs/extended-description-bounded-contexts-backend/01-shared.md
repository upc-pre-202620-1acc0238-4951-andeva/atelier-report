...
| `schema_version` | `INTEGER` | NOT NULL | `1` | Control de Migración | Versión estructural del modelo de datos para gestionar migraciones automáticas de base de datos local Room/Drift. |
